...
class TechnicianTicketDetailPageModel
  ...
  // Stores action output result for [Backend Call - Query Rows] action in technicianTicketDetailPage widget.
  List<TicketDetailVRow>? sourceTechnicianDetailRows;
  // Stores action output result for [Backend Call - Query Rows] action in technicianTicketDetailPage widget.
  List<TicketEventsRow>? sourceTechnicianEventRows;
