                    ...
                    child: Stack(
                      children: [
                        if (!functions.hasUploadedMedia(
                            _model.uploadedFileUrl_uploadDataS5t))
                          InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadDataQ5l = true);
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(context)
                                      .hideCurrentSnackBar();
                                  _model.isDataUploading_uploadDataQ5l = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadDataQ5l =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadDataQ5l =
                                        downloadUrls.first;
                                  });
                        ...
                        if (functions.hasUploadedMedia(
                          ...
                          Align(
                            ...
                            child: FlutterFlowMediaDisplay(
                              path: _model.uploadedFileUrl_uploadDataS5t,
                                ...
                                if (selectedMedia != null &&
                                    selectedMedia.every((m) =>
                                        validateFileFormat(
                                            m.storagePath, context))) {
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataNzi = true);
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadDataNzi =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                          selectedMedia.length &&
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataNzi =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadDataNzi =
                                          downloadUrls.first;
                                    });
                                    showUploadMessage(context, 'Success!');
                                  } else {
                                ...
                                if (selectedMedia != null &&
                                    selectedMedia.every((m) =>
                                        validateFileFormat(
                                            m.storagePath, context))) {
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataS5t = true);
                                  var selectedUploadedFiles =
                                      <FFUploadedFile>[];
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadDataS5t =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                          selectedMedia.length &&
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataS5t =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadDataS5t =
                                          downloadUrls.first;
                                    });
