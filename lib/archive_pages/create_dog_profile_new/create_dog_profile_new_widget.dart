                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      ...
                      if (selectedMedia != null &&
                        ...
                        safeSetState(
                            () => _model.isDataUploading_uploadDataKmy = true);
                        ...
                        try {
                          ...
                          _model.isDataUploading_uploadDataKmy = false;
                        }
                        if (selectedUploadedFiles.length ==
                                selectedMedia.length &&
                            downloadUrls.length == selectedMedia.length) {
                          safeSetState(() {
                            _model.uploadedLocalFile_uploadDataKmy =
                                selectedUploadedFiles.first;
                            _model.uploadedFileUrl_uploadDataKmy =
                                downloadUrls.first;
                          });
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  await DogsRecord.collection.doc().set(createDogsRecordData(
                        ...
                        dogPhoto: _model.uploadedFileUrl_uploadDataKmy,
