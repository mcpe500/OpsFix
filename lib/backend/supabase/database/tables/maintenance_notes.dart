...
class MaintenanceNotesTable extends SupabaseTable<MaintenanceNotesRow> {
  @override
  String get tableName => 'maintenance_notes';

  @override
  MaintenanceNotesRow createRow(Map<String, dynamic> data) =>
      MaintenanceNotesRow(data);
}

class MaintenanceNotesRow extends SupabaseDataRow {
  MaintenanceNotesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MaintenanceNotesTable();
