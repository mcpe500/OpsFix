...
import 'technician_ticket_detail_page_copy_model.dart';
export 'technician_ticket_detail_page_copy_model.dart';

/// Operational ticket detail and work-execution screen for technician Dimas
/// Pratama in OpsFix (In Progress status)
class TechnicianTicketDetailPageCopyWidget extends StatefulWidget {
  const TechnicianTicketDetailPageCopyWidget({super.key});

  static String routeName = 'technicianTicketDetailPageCopy';
  static String routePath = '/technicianTicketDetailPageCopy';

  @override
  State<TechnicianTicketDetailPageCopyWidget> createState() =>
      _TechnicianTicketDetailPageCopyWidgetState();
}

class _TechnicianTicketDetailPageCopyWidgetState
    extends State<TechnicianTicketDetailPageCopyWidget> {
  late TechnicianTicketDetailPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TechnicianTicketDetailPageCopyModel());

    _model.technicianNoteFieldTextController ??= TextEditingController();
    _model.technicianNoteFieldFocusNode ??= FocusNode();
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        controller: _model
                                            .technicianNoteFieldTextController,
                                        focusNode:
