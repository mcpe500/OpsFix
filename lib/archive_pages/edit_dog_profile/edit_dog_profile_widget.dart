                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (selectedMedia != null &&
                          ...
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataGj1 = true);
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadDataGj1 = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedMedia.length &&
                              downloadUrls.length == selectedMedia.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataGj1 =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadDataGj1 =
                                  downloadUrls.first;
                            });
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await widget!.dogProfile!.reference
                                ...
                                dogPhoto: _model.uploadedFileUrl_uploadDataGj1,
