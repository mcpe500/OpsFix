                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadDataOfr = true);
                                  ...
                                  try {
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .hideCurrentSnackBar();
                                    _model.isDataUploading_uploadDataOfr =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadDataOfr =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadDataOfr =
                                          downloadUrls.first;
                                    });
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await currentUserReference!
                              ...
                              photoUrl: _model.uploadedFileUrl_uploadDataOfr,
